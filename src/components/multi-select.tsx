  ...
  (
    ...
    return (
      ...
      >
        ...
        >
          <div dir={'rtl'} className='relative flex flex-wrap gap-1'>
            {selected.map((option) => {
              return (
                <Badge
                  key={option.value}
            ...
            <CommandPrimitive.Input
              ...
              className={cn(
                'flex-1 bg-transparent text-right outline-none placeholder:text-muted-foreground',
                {
