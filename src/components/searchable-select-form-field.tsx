        ...
        <FormItem className={className}>
          ...
          <Popover open={open} onOpenChange={setOpen}>
                ...
                >
                  ...
                  {field.value
                    ? labelFormattingFn
                      ...
                      // @ts-expect-error Ignore this
                      : selectList?.flat(1).find((item) => item[elementValueKey] === field.value)?.[
                          elementLabelKey
                        ]
            ...
            <PopoverContent className={'p-0'}>
              <Command>
                <CommandInput placeholder={placeholder && `...اختر ${placeholder}`} className="h-9" />
                  ...
                  {!hasMultipleSelectLists ? (
                    ...
                    selectList.map((element, index) => (
                      <CommandGroup key={index} heading={selectListTitles ? selectListTitles : [index]}>
                        {Array.isArray(element) && element?.map((item) => (
                          <CommandItem
                            // Value is referring to the label key. This is correct and intended
                            value={
